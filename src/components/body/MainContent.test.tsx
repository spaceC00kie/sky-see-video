...
jest.mock("../pages/services/OurServices", () => ({
  OurServices: () => (
    <div data-testid="our-services-page">Our Services Page</div>
  ),
}))
...
jest.mock("../pages/services/Construction", () => ({
  Construction: () => (
    <div data-testid="construction-page">Construction Page</div>
  ),
}))
...
jest.mock("../pages/services/CorporateMarketing", () => ({
  CorporateMarketing: () => (
    <div data-testid="corporate-page">Corporate Page</div>
  ),
}))

jest.mock("../pages/services/Documentaries", () => ({
  Documentaries: () => (
    <div data-testid="documentaries-page">Documentaries Page</div>
  ),
}))
