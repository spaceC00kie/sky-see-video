    ...
    <div className="flex w-full flex-col gap-10 px-6">
      ...
      <div className="flex flex-col gap-7 text-2xl">
        ...
        <p>
          ...
          team members working overtime to meet project deadlines, the need for
          outside consultation and production support has never been greater.
        </p>

        <p>
          Picking the right team you can trust means less oversight, more
          efficient use of internal time &amp; resources, and the assurance that
          deadlines are met. At SkySee Video, we’ll respect, protect and project
          your brand, creating work that drives viewers and grows your business.
          From long-form campaigns to snackable social media content, you’ve got
          marketing needs and we’ve got video solutions.
        </p>
      ...
      <button className="flex w-64 items-center justify-center gap-2 rounded-sm bg-sky-600 p-3 text-white hover:bg-sky-500">
        <CiMail />
