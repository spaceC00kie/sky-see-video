...
const mockProps = {
  ...
  description: 'John has over 10 years of experience in the video production industry and specializes in cinematic storytelling.',
}
...
describe('AboutUsCard', () => {
  ...
  it('has correct container structure', () => {
    ...
    expect(container.firstChild).toHaveClass(
      'flex', 'flex-col', 'items-start', 'gap-2', 'text-lg'
    )
  })
  ...
  it('handles long description text', () => {
    const longDescriptionProps = {
      ...mockProps,
      description: 'This is a very long description that goes into great detail about the person\'s background, experience, and expertise in the video production field. It should still render correctly within the card layout.',
    }
  ...
  it('has hover effect styling', () => {
    const { container } = render(<AboutUsCard {...mockProps} />)
    const overlaySpan = container.querySelector('.pointer-events-none.absolute.inset-0.bg-white.opacity-0')
