    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="flex max-w-[70em] flex-col gap-4 px-6 pt-5 pb-40">
        ...
        <p className="p-2 text-xl">
          You’ve got specific media needs, and SkySee Video has the expertise
          to help you achieve them. We’re a boutique production company with
          film and corporate backgrounds, providing fresh perspectives for
          branding and marketing campaigns. From initial concepts to
          broadcast-quality final videos and animations, our experience and
          passion focus on companies, their people, the products they build, and
          the services they provide. Our knowledge of the industry and the
          production process means we’ll save you valuable time and money as we
          execute your plan, bringing your vision to life with stunning
          audio/video assets and exceptional storytelling.
        </p>
