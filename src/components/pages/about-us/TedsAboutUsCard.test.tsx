...
describe('TedsAboutUsCard', () => {
  ...
  it('includes external link to portfolio', () => {
    ...
    expect(portfolioLink).toHaveAttribute('href', 'https://tintorcio.myportfolio.com/')
  ...
  it('has correct styling classes', () => {
    ...
    expect(mainContainer).toHaveClass('flex', 'flex-col', 'items-start', 'gap-2', 'text-lg')
  })
  ...
  it('portfolio link has correct styling', () => {
    ...
    const portfolioLink = getByRole('link', { name: 'his personal website' })
    expect(portfolioLink).toHaveClass('text-blue-600', 'underline', 'hover:text-blue-800')
  })
  ...
  it('has hover effect element', () => {
    ...
    const hoverEffect = container.querySelector('.opacity-0.transition-opacity.group-hover\\:opacity-40')
