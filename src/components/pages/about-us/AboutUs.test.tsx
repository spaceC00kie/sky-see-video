...
describe('AboutUs', () => {
  ...
  it('displays team member descriptions', () => {
    ...
    expect(getByText(/With over three decades in advertising/)).toBeInTheDocument()
    expect(getByText(/Rob, a native of Haiti/)).toBeInTheDocument()
    expect(getByText(/Charles is a multi-Emmy-Award-winning/)).toBeInTheDocument()
  })
  ...
  it('has correct layout structure', () => {
    ...
    const gridContainer = container.querySelector('.grid.gap-5.md\\:grid-cols-2')
