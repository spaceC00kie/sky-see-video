      ...
      <div className="flex max-w-[70em] flex-col gap-8 pb-20">
        <div className="flex w-full flex-col gap-4 px-6">
          ...
          <div className="flex flex-col gap-3 text-lg">
            ...
            <p>
              At SkySee Video, we offer complete on-the-ground and aerial video
              services for the tourism industry. We work with community
              organizers, restaurants, retailers, attractions, and all types of
              lodging facilities to create visually stunning panoramas travelers
              will want to see for their own eyes. Show travelers the best
              impression of what you offer.
            </p>
            <p>
              Show off sparkling blue-green waters, a beautiful fall skyline, or
              your fall boutique product lineup with a custom-produced video
              made with your value proposition in mind. Take viewers on a local
              zip-line or give them a behind-the-scenes view of a chef artfully
              cooking steak flambé. Come to SkySee Video for all your tourism
              video needs.
            </p>
          </div>
        </div>
        <div className="flex w-full flex-col gap-4 px-6">
          ...
          <ul className="list-[circle] ml-5">
            <li>
              ...
              <span>
                ...
                Instagram with vibrant, short, and entertaining videos. Display
                a highlight reel of your location’s features, make a quick
                statement, or walk-through an experience. Give your social media
                followers another reason to book their next outing with your
                brand.
              </span>
            </li>
            <li>
            ...
            <li>
              ...
              <span>
                ...
                your people, places and products. We’ll work with your marketing
                team to highlight the best visual cues to give your webpage
                background depth and meaning. Consider a cinemagraph (a living
                photograph with only one or two moving elements) to catch your
                audience off guard. Improve conversions with a video designed
                with your website needs in mind.
              </span>
            </li>
            <li>
          ...
          <p className="text-lg">
            Whether you’re working on general marketing activities or focused on
            a certain campaign, we can help you create a video you’ll love to
            share with your audience. From raw footage handoffs to full video
            packaging, we’ll deliver exactly what you need, on time, and on
            budget.
          </p>
        </div>
        <div className="flex w-full flex-col gap-4 px-6">
          <h2 className="text-blue-500 text-2xl">Partner with SkySee Video</h2>
          <p className="text-lg">
            When you need fresh marketing and advertising materials, who you
            partner with matters. Your audience will see a poorly executed video
            project a mile away. Instead of relying on amateur teams, give your
            audience an immersive experience with professional videography.
          </p>
          <p className="text-lg">
            At SkySee Video, our business is fully FAA certified for commercial
            drone usage during the day and at night. We carry ample insurance to
            protect our clients, and we can travel quickly anywhere in the
            Southeast to capture the right moment for your project. With access
            to a network of professionals who specialize in design, writing, and
            other areas of production, we are truly a full-service video service
            firm.
          </p>
          <p className="text-lg">
