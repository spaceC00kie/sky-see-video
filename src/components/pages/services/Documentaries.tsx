          ...
          <div className="flex w-full flex-col gap-4 px-6">
            ...
            <div className="flex flex-col gap-3 text-lg">
              <p>
                ...
                at a rapid pace, change course at any time, and have the gear
                that allows the crew to be highly mobile. Every project is
                different, but the rigorous standards for quality remain the
                same. Anything less than the best simply won’t cut it. At SkySee
                Video, our videographers work to create seamless, multicam
                shoots, and use precision flying techniques to capture
                meaningful footage that producers love to see in their content,
                and viewers love to see in their films.
              </p>
            </div>
          </div>
          <div className="flex w-full flex-col gap-4 px-6">
            ...
            <p>
              ...
              outdoor activities. Aerial footage capabilities transcend
              traditional cinematography techniques to deliver new angles with
              incredible clarity. The storytelling skills of our videographers
              and drone operators ensure that you’ll capture the moments you
