...
describe('OurServicesCard2', () => {
  ...
  it('has correct navigation links', () => {
    const { getAllByRole } = renderWithRouter(<OurServicesCard2 {...mockProps} />)
  ...
  it('has correct container structure and styling', () => {
    ...
    expect(container.firstChild).toHaveClass(
      'flex', 'flex-col', 'items-center', 'justify-start', 'gap-3', 'p-5', 'lg:w-64'
    )
  })
  ...
  it('image container has correct styling', () => {
    const { container } = renderWithRouter(<OurServicesCard2 {...mockProps} />)
    const imageContainer = container.querySelector('.grid.place-content-center.pb-2')
  ...
  it('handles long description text', () => {
    const longDescriptionProps = {
      ...mockProps,
      description: 'This is a very long description that should still render correctly and maintain proper formatting within the card component structure.',
    }
    const { getByText } = renderWithRouter(<OurServicesCard2 {...longDescriptionProps} />)
  ...
  it('handles long title text', () => {
    ...
    const { getByText } = renderWithRouter(<OurServicesCard2 {...longTitleProps} />)
