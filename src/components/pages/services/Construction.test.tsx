...
describe('Construction', () => {
  ...
  it('renders video iframe with correct attributes', () => {
    ...
    expect(iframe).toHaveAttribute('src', 'https://player.vimeo.com/video/193616058?h=af982b45c1&dnt=1')
    expect(iframe).toHaveAttribute('title', 'Construction Videography | SkySee Video')
