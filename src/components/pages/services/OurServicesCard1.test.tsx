...
describe('OurServicesCard1', () => {
  ...
  it('has correct container structure and styling', () => {
    ...
    expect(container.firstChild).toHaveClass(
      'flex', 'flex-col', 'justify-start', 'gap-3', 'w-full', 'sm:max-w-64'
    )
  })
  ...
  it('list items have correct styling', () => {
    ...
    listItems.forEach(item => {
      expect(item).toHaveClass('flex', 'items-start', 'gap-2', 'pl-2', 'text-xl')
    })
  })
  ...
  it('handles empty bullet points array', () => {
    ...
    const { getByRole, queryAllByRole } = render(<OurServicesCard1 {...emptyProps} />)
  ...
  it('handles single bullet point', () => {
    ...
    const { getAllByRole, getByText } = render(<OurServicesCard1 {...singleProps} />)
