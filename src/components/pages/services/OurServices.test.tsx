...
describe('OurServices', () => {
  ...
  it('displays main service description', () => {
    ...
    expect(getByText(/production and post-production services/)).toBeInTheDocument()
  })
  ...
  it('renders hero banner', () => {
    const { container } = renderWithProviders(<OurServices />)
    const heroImage = container.querySelector('img[alt="SkySee Video services"]')
  ...
  it('has service cards container with proper styling', () => {
    ...
    const serviceCardsContainer = container.querySelector('.flex.flex-col.flex-wrap.justify-evenly')
  ...
  it('has industry grid layout', () => {
    ...
    const industryGrid = container.querySelector('.grid.md\\:grid-cols-2.lg\\:grid-cols-4')
