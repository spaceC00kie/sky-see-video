      ...
      <div className="flex max-w-[70em] flex-col gap-4 px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4">
          <OurServicesCard2
            image={construction}
            title="Construction"
            description="Stand out at conventions, trade shows, on social media, and more. SkySee Video helps today’s home builders and developers highlight the uniqueness of their properties and developments with broadcast-quality video packaging. Builders who are LEED compliant can take advantage of SkySee Video’s infrared cameras, emphasizing your company’s green commitment to the environment."
